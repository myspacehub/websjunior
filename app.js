...
const UNIT_DETAIL_RULES = {
  语文: [
    ...
    {
      keys: ["散文", "写景", "山水", "游记", "民俗", "亲情", "人物", "家国", "生命", "哲理", "想象", "科幻", "文学作品", "综合复习"],
  ...
  数学: [
    ...
    {
      keys: ["几何图形", "相交线", "平行线", "三角形", "全等", "轴对称", "勾股", "平行四边形", "旋转"],
  ...
  道德与法治: [
    ...
    {
      keys: ["富强", "创新", "民主", "文明", "家园", "和谐", "梦想", "世界", "中国", "未来", "时政"],
  ...
  历史: [
    ...
    {
      keys: ["半殖民地", "近代化", "民主革命", "新民主主义", "国共", "抗日", "解放", "近代经济"],
    ...
    {
      keys: ["中华人民共和国", "社会主义", "中国特色社会主义", "民族团结", "祖国统一", "国防外交", "科技文化"],
    ...
    {
      keys: ["亚非文明", "欧洲文明", "封建时代", "走向近代", "资本主义", "工业革命", "殖民地", "世界大战", "冷战", "和平发展"],
  ...
  物理: [
    ...
    {
      keys: ["电流和电路", "电压 电阻", "欧姆定律", "电功率", "生活用电"],
